...
ENGINE_ERROR_CODE assoc_init(struct pagecache_engine *engine) {
...
hash_item *assoc_find(struct pagecache_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
    hash_item *it;
...
static hash_item** _hashitem_before(struct pagecache_engine *engine,
                                    uint32_t hash,
                                    const char *key,
                                    const size_t nkey) {
    hash_item **pos;
...
static void assoc_expand(struct pagecache_engine *engine) {
...
int assoc_insert(struct pagecache_engine *engine, uint32_t hash, hash_item *it) {
    unsigned int oldbucket;
...
void assoc_delete(struct pagecache_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
...
static void *assoc_maintenance_thread(void *arg) {
    struct pagecache_engine *engine = arg;
    bool done = false;
    do {
        int ii;
